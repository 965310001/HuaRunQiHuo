...
//                volume(1, false);
//                LoggerManager.i(TAG, "volumeDown-activity_foget_password:" + activity.getClass().getSimpleName());
//                return true;
//            case KeyEvent.KEYCODE_VOLUME_UP:
//                volume(1, true);
//                LoggerManager.i(TAG, "volumeUp-activity_foget_password:" + activity.getClass().getSimpleName());
//                return true;
//        }
//        return false;
//    }
    ...
    public void setContentViewBackground(View contentView, Class<?> cls) {
        ...
        if (!Fragment.class.isAssignableFrom(cls)
            ...
            contentView.setBackgroundResource(R.color.colorWhite);
        }
    }
...
//                        .setBottomView(PicturePreviewActivity.class.isAssignableFrom(activity_foget_password.getClass()) ?
...
//                        LoggerManager.i(TAG, "isNavigationBarVisible:" + com.aries.library.fast.demo.util.NavigationBarUtil.isNavigationBarVisible(activity_foget_password) + ";checkDeviceHasNavigationBar:" +
//                                com.aries.library.fast.demo.util.NavigationBarUtil.checkDeviceHasNavigationBar(activity_foget_password) +
//                                ";getNavigationBarHeight:" + com.aries.library.fast.demo.util.NavigationBarUtil.getNavigationBarHeight(activity_foget_password) + ";getSystemUiVisibility:" + activity_foget_password.getWindow().getDecorView().getSystemUiVisibility());
            }
        });
...
//        LoggerManager.i(TAG, "smartRefreshLayout:" + smartRefreshLayout + ";adapter:" + adapter + ";status:" + ";page:" + page + ";class:" + httpRequestControl.getRequestClass());
    ...
    private void setStatusBarActivity(Activity activity) {
        //暂时注释掉
        //        if (PictureBaseActivity.class.isAssignableFrom(activity_foget_password.getClass())) {
        //            View contentView = FastUtil.getRootView(activity_foget_password);
        //            //该属性会影响适配滑动返回效果
        ...
        //                if (layout != null) {
        //                    ViewCompat.setElevation(layout, activity_foget_password.getResources().getDimension(R.dimen.dp_elevation));
        //                }
        //                //调整返回箭头大小
...
/*    @Nullable
    @Override
    public LoadDialog createLoadingDialog(@Nullable Activity activity_foget_password, String text) {
        //注意使用UIProgressDialog时最好在Builder里设置提示文字setMessage不然后续再设置文字信息也不会显示
        return new LoadDialog(activity_foget_password, new UIProgressDialog.WeChatBuilder(activity_foget_password)
                ...
                .setIndeterminateDrawable(FastUtil.getTintDrawable(ContextCompat.getDrawable(mContext, R.drawable.dialog_loading), ContextCompat.getColor(mContext, R.color.colorLoadMoreText)))
    ...
    @Nullable
    @Override
    public LoadDialog createLoadingDialog(@Nullable Activity activity) {
        //注意使用UIProgressDialog时最好在Builder里设置提示文字setMessage不然后续再设置文字信息也不会显示
