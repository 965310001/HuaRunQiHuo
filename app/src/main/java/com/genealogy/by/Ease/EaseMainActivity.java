...
import com.genealogy.by.Ease.fragment.ChatFragment;
import com.genealogy.by.Ease.fragment.ContactFragment;
import com.genealogy.by.Ease.fragment.FoundFragment;
import com.genealogy.by.Ease.fragment.MeFragment;
import com.genealogy.by.Ease.ui.ChangeColorIconWithText;
import com.genealogy.by.R;

import java.util.ArrayList;
import java.util.List;

public class EaseMainActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener, View.OnClickListener{
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()){
                    case R.id.toolbar_search:       //　Toolbar查找按钮点击事件
                        Toast.makeText(EaseMainActivity.this, "Search", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.toolbar_add:      //Toolbar的Overflow按钮的点击时间
                        // 先获取Overflow的View对象
                        overflowBtn = (ActionMenuItemView) findViewById(R.id.toolbar_add);
                        // 将PopupMenu绑定在Overflow对象上
                        PopupMenu popupMenu = new PopupMenu(EaseMainActivity.this, overflowBtn);
...
//                                        startActivity(new Intent(MainActivity.this, AddFriendActivity.class));
                                    ...
                                    case R.id.menu_group_chat:
                                        Toast.makeText(EaseMainActivity.this, "Group chat", Toast.LENGTH_SHORT).show();
                                        break;
                                    case R.id.menu_scan:
                                        Toast.makeText(EaseMainActivity.this, "Scan", Toast.LENGTH_SHORT).show();
                                        break;
                                    case R.id.menu_feedback:
                                        Toast.makeText(EaseMainActivity.this, "Feedback", Toast.LENGTH_SHORT).show();
                                        break;
                                }
                                return true;
                            }
